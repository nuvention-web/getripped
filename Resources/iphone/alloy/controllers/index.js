function Controller() {
    ...
    $.__views.indexWin.add($.__views.__alloyId23);
    var __alloyId26 = [];
    ...
    __alloyId26.push($.__views.titleLabel);
    $.__views.__alloyId28 = Ti.UI.createButton({
        systemButton: Ti.UI.iPhone.SystemButton.FLEXIBLE_SPACE
    });
    __alloyId26.push($.__views.__alloyId28);
    $.__views.__alloyId24 = Ti.UI.iOS.createToolbar({
        items: __alloyId26,
        top: "15",
        borderTop: "true",
        borderBottom: "true",
    ...
    __alloyId29.push($.__views.view1);
    $.__views.__alloyId30 = Ti.UI.createImageView({
        image: "img1.png",
        id: "__alloyId30"
    });
    $.__views.view1.add($.__views.__alloyId30);
    $.__views.view2 = Ti.UI.createView({
        id: "view2",
        height: "100%",
        width: "100%"
    });
    __alloyId29.push($.__views.view2);
    $.__views.__alloyId31 = Ti.UI.createImageView({
        image: "img2.png",
        id: "__alloyId31"
    });
    $.__views.view2.add($.__views.__alloyId31);
    $.__views.view3 = Ti.UI.createView({
        id: "view3",
        height: "100%",
        width: "100%"
    });
    __alloyId29.push($.__views.view3);
    ...
    $.__views.view3.add($.__views.__alloyId33);
    ...
    $.__views.__alloyId23.add($.__views.view4);
    ...
    $.__views.__alloyId23.add($.__views.view5);
